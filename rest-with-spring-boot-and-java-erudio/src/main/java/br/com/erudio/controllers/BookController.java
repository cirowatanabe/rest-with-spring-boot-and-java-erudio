...
@Tag(name="Books", description="Endpoints para livros!")
public class BookController {
	...
	@Operation(summary = "Encontra todos os livros", description = "Encontra todos os livros", tags = {
	...
	@Operation(summary = "Encontra um livro", description = "Encontra um livro", tags = { "Books" }, responses = {
	...
	@Operation(summary = "Adiciona um livro", description = "Adiciona um livro", tags = { "Books" }, responses = {
			@ApiResponse(description = "Success", responseCode = "200", content = @Content(schema = @Schema(implementation = PersonVO.class))),
			@ApiResponse(description = "Bad Request", responseCode = "400", content = @Content),
			@ApiResponse(description = "Unauthorized", responseCode = "401", content = @Content),
			@ApiResponse(description = "Internal Error", responseCode = "500", content = @Content), })
	...
	@PutMapping(produces = { MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML,
			MediaType.APPLICATION_YML }, consumes = { MediaType.APPLICATION_JSON, MediaType.APPLICATION_YML })
	@Operation(summary = "Atualiza um livro", description = "Atualiza um livro", tags = { "Books" }, responses = {
	...
	@Operation(summary = "Deleta um livro", description = "Deleta um livro", tags = { "Books" }, responses = {
			@ApiResponse(description = "No Content", responseCode = "204", content = @Content),
			@ApiResponse(description = "Bad Request", responseCode = "400", content = @Content),
			@ApiResponse(description = "Unauthorized", responseCode = "401", content = @Content),
			@ApiResponse(description = "Not Found", responseCode = "404", content = @Content),
